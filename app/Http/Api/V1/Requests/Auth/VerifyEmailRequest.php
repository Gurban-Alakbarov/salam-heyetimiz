...
/** Validates POST /v1/auth/verify-email (email + 6-digit code + device fingerprint). Used by both
 *  registration-verify and email-login-verify. */
class VerifyEmailRequest extends RegistrationRequest
{
    /**
